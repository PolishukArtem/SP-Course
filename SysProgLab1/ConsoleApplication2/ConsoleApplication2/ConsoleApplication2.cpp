...
void ANSI_To_Unicode(LPCSTR fileName)
{
	...
	CHAR nameDestinationFile[] = "C:\\Users\\Acer\\source\\repos\\ConsoleApplication2\\ANSI_Text_To_Unicode.txt";
...
void Unicode_To_ANSI(LPCSTR fileName)
{
	...
	CHAR* ansiBuff; 
	BOOL resultFile = true;
	CHAR nameDestinationFile[] = "C:\\Users\\Acer\\source\\repos\\ConsoleApplication2\\Unicode_Text_To_ANSI.txt";
	printf("\nРезультат можно увидеть -> %s\n", nameDestinationFile);
